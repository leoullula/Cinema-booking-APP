...
import 'package:cinema_appp/pages/store.dart';
...
import 'package:cinema_appp/widgets/cinema-ticket/ticket-detail.dart';
              ...
              Container(
                ...
                child: new RaisedButton(
                  child: Row(
                    ...
                    children: [
                      Icon(Icons.save),
                      new Text(loading ? "Processing..." : "Store Information",
                          style: new TextStyle(
                            color: Colors.white,
                          )),
                    ],
                  ...
                  onPressed: () {
                    Navigator.push(
                        context,
                        MaterialPageRoute(
                            builder: (context) => MyAppstore(widget.ticket.date,
                                widget.ticket.seats, widget.ticket.time)));
                  },
                  color: Colors.blue,
                ),
              ),
